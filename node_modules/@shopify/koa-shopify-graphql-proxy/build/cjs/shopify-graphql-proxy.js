...
var PROXY_BASE_PATH = '/graphql';
exports.PROXY_BASE_PATH = PROXY_BASE_PATH;
var GRAPHQL_PATH_PREFIX = '/admin/api';
...
function shopifyGraphQLProxy(proxyOptions) {
  return /*#__PURE__*/function () {
    var _shopifyGraphQLProxyMiddleware = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee(ctx, next) {
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 11:
              _context.next = 13;
              return (0, _koaBetterHttpProxy["default"])(shop, {
                https: true,
                parseReqBody: false,
...
function _noop() {
  _noop = _asyncToGenerator( /*#__PURE__*/_regenerator["default"].mark(function _callee2() {
