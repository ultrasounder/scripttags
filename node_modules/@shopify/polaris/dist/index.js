...
const COLORS_WITH_BACKDROPS = ['blueDark', 'teal', 'tealDark', 'greenDark', 'redDark', 'yellowDark', 'ink', 'inkLighter', // new DL colors
'base', 'subdued', 'critical', 'warning', 'highlight', 'success', 'primary']; // This is needed for the polaris
...
class PopoverOverlay extends React.PureComponent {
  constructor(...args) {
    ...
    this.renderPopover = overlayDetails => {
      ...
      const content = /*#__PURE__*/React__default.createElement("div", {
        id: id,
        tabIndex: preventAutofocus || autofocusTarget === 'none' ? undefined : -1,
  ...
  focusContent() {
    ...
    if (preventAutofocus) {
      // eslint-disable-next-line no-console
      console.warn('Deprecation: The preventAutofocus prop has been deprecated. Use autofocusTarget: "none" instead. Read more at [https://github.com/Shopify/polaris-react/issues/3602]');
    }

    if (preventAutofocus || autofocusTarget === 'none' || this.contentNode == null) {
      return;
    }
...
function UnstyledButton(_ref) {
  let {
    ...
    onTouchStart
      ...
      rest = _objectWithoutProperties(_ref, ["id", "children", "className", "url", "external", "download", "submit", "disabled", "loading", "pressed", "accessibilityLabel", "role", "ariaControls", "ariaExpanded", "ariaDescribedBy", "ariaPressed", "onClick", "onFocus", "onBlur", "onKeyDown", "onKeyPress", "onKeyUp", "onMouseEnter", "onTouchStart"]);
...
function Button({
  ...
  if (stretchContent && !hasGivenDeprecationWarning.current) {
    // eslint-disable-next-line no-console
    console.warn('Deprecation: The `stretchContent` prop has been replaced with `textAlign="left"`');
    hasGivenDeprecationWarning.current = true;
  }
...
function TextField({
  ...
  const clearButtonClassName = classNames(styles$w.ClearButton, !clearButtonVisible && styles$w['ClearButton-hidden']);
...
function Collapsible({
  ...
  const collapisbleContainer = React.useRef(null);
  const isFullyOpen = animationState === 'idle' && open && isOpen;
  const isFullyClosed = animationState === 'idle' && !open && !isOpen;
  const content = expandOnPrint || !isFullyClosed ? children : null;
  const wrapperClassName = classNames(styles$L.Collapsible, isFullyClosed && styles$L.isFullyClosed, expandOnPrint && styles$L.expandOnPrint);
...
class ConnectedFilterControl extends React.Component {
  ...
  render() {
    ...
    const RightContainerClassName = classNames(styles$Y.RightContainer, !shouldRenderMoreFiltersButton && styles$Y.RightContainerWithoutMoreFilters, queryFieldHidden && styles$Y.queryFieldHidden);
    ...
    const moreFiltersButtonContainerClassname = classNames(styles$Y.MoreFiltersButtonContainer, actionsToRender.length === 0 && (newDesignLanguage || queryFieldHidden) && styles$Y.onlyButtonVisible);
...
function CloseButton({
  ...
  return /*#__PURE__*/React__default.createElement("button", {
    onClick: onClick,
    className: styles$15.CloseButton,
...
function Header$1({
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: titleHidden || !children ? styles$16.titleHidden : styles$16.Header
  }, /*#__PURE__*/React__default.createElement("div", {
    id: id,
...
function Item$7({
  ...
  if (subNavigationItems.length > 0) {
    ...
    const SecondaryNavigationClassName = classNames(styles$1h.SecondaryNavigation, showExpanded && styles$1h.isExpanded, !icon && styles$1h['SecondaryNavigation-noIcon']);
